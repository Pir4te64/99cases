  ...
  return (
    <div className="mb-6 rounded bg-[#EEEEEE] p-4 shadow-lg">
      ...
      <p className="font-favoritExpanded text-[#000000]">
        <strong className="font-favoritExpanded text-[#000000]">Destino:</strong> {deliveryResponse.destino || 'No especificado'}
      </p>
      <p className="font-favoritExpanded text-[#000000]">
        <strong className="font-favoritExpanded text-[#000000]">Contacto:</strong> {deliveryResponse.datosDeContacto || 'No especificado'}
      </p>
      <p className="font-favoritExpanded text-[#000000]">
      ...
      <div className="mt-4">
        ...
        <ul>
          {deliveryResponse.deliveryOptions.map((opt, index) => (
            <li key={`${opt.modoDeEntregaId || index}`} className="mb-2 flex items-center font-favoritExpanded text-[#000000]">
              <input
                type="radio"
                ...
                className="mr-2"
              />
              <label htmlFor={`delivery-option-${opt.modoDeEntregaId || index}`} className="font-favoritExpanded text-[#000000]">
